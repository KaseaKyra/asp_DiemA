<%@ Page Title="" Language="C#" MasterPageFile="~/CoursesMasterPage.master" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="HocTN_TuVanDH.Courses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCourseContent" runat="server">
    ...
    <asp:ListView ID="lvwCourses" runat="server" DataKeyNames="Id" DataSourceID="sqlDataSrcCourses">
        ...
        <LayoutTemplate>
            <div id="itemPlaceholderContainer" runat="server" style="font-family: Verdana, Arial, Helvetica, sans-serif;">
                ...
                <asp:Label ID="GhichuLabel" runat="server" Text='<%# Eval("Ghichu") %>'></asp:Label>
                <br />
                <br />
                </span>
            </div>
    ...
    <asp:SqlDataSource ID="sqlDataSrcCourses" runat="server" ConnectionString="<%$ ConnectionStrings:connect_DATN %>" SelectCommand="Proc_GetListCourses" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
