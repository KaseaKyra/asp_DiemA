<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDuHoc.master" AutoEventWireup="true" CodeBehind="TimKiemTruongHoc.aspx.cs" Inherits="HocTN_TuVanDH.TimKiemTruongHoc" %>

<asp:Content ID="Content3" ContentPlaceHolderID="cphDSTruong" runat="server">
    <asp:ListView ID="lvwSearchSchool" runat="server" DataKeyNames="Id" DataSourceID="dataSrcSearchSchool">
        ...
        <EditItemTemplate>
            <span style="background-color: #999999;">Link ảnh:
                            <asp:TextBox ID="Link_ảnhTextBox" runat="server" Text='<%# Bind("[Link ảnh]") %>' /><br />
                Tên trường
                                <asp:TextBox ID="Tên_trườngTextBox" runat="server" Text='<%# Bind("[Tên trường]") %>' /><br />
                Giá tiền:
                                <asp:TextBox ID="Giá_tiềnTextBox" runat="server" Text='<%# Bind("[Giá tiền]") %>' /><br />
                Ngành đào tạo:
                                <asp:TextBox ID="Ngành_đào_tạoTextBox" runat="server" Text='<%# Bind("[Ngành đào tạo]") %>' /><br />
                Ghi chú:
                                <asp:TextBox ID="Ghi_chúTextBox" runat="server" Text='<%# Bind("[Ghi chú]") %>' /><br />
                Id:
    ...
    <asp:SqlDataSource ID="dataSrcSearchSchool" runat="server" ConnectionString="<%$ ConnectionStrings:connect_DATN %>" SelectCommand="Proc_GetSchoolWhenSearch" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="name" Name="Name" QueryStringField="name" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
