<%@ Page Title="" Language="C#" MasterPageFile="~/CoursesMasterPage.master" AutoEventWireup="true" CodeBehind="TimKiemKhoaHoc.aspx.cs" Inherits="HocTN_TuVanDH.TimKiemKhoaHoc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphCourseContent" runat="server">
    <asp:ListView ID="lvwTkkh" runat="server" DataKeyNames="Id" DataSourceID="sqlDataSrcTkkh">
    ...
    <asp:SqlDataSource ID="sqlDataSrcTkkh" runat="server" ConnectionString="<%$ ConnectionStrings:connect_DATN %>" SelectCommand="Proc_GetCoursesByName" SelectCommandType="StoredProcedure">
        <SelectParameters>
